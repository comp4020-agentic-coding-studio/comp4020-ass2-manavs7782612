...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "Twelve weeks at the bench, one bread a week. Take each loaf apart — what " +
    "the flour is doing, what the fermentation is doing, what the oven is " +
    "doing — then bake it and find out whether the theory held.",
  tags: ["baking", "fermentation", "food science"],
